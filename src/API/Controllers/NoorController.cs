...
public class NoorController : ControllerBase
{
        ...
        [FromQuery] string filterMode = "today")
    {
        ...
        if (type is "all" or "violations")
        {
            ...
            foreach (var item in items)
            {
                ...
                var violMap = NoorMappings.GetViolationsMap();
                if (!string.IsNullOrEmpty(item.violationCode) && violMap.TryGetValue(item.violationCode, out var mapping))
                {
    ...
    /// <summary>تحويل نوع العذر إلى قيمة نور</summary>
...
public static class NoorMappings
{
    ...
    public static object GetAll() => new
    {
        ...
        violations = _violations.ToDictionary(kv => kv.Key, kv => (object)new { noorText = kv.Value.noorText, noorValue = kv.Value.noorValue }),
        ...
        violationsPrimary = new Dictionary<string, string?>
        {
            ["105"] = null,
            ["109"] = "109,1",
            ["301"] = "301,1", ["302"] = "302,2", ["303"] = "303,2", ["304"] = "304,2",
            ["305"] = "305,2", ["306"] = "306,2", ["307"] = null, ["308"] = "308,4",
            ["309"] = "309,4", ["311"] = "311,2",
            ["401"] = "401,3", ["402"] = "402,3", ["404"] = "404,3",
            ["406"] = "406,3", ["407"] = "407,3", ["408"] = "408,4",
            ["501"] = "501,4", ["502"] = "502,4", ["503"] = "503,4", ["504"] = null,
            ["506"] = "506,4", ["507"] = "507,4", ["508"] = "508,4", ["509"] = "509,4",
            ["510"] = null, ["511"] = "511,4", ["512"] = null, ["513"] = "513,4",
            ["606"] = "606,2", ["607"] = "607,2", ["608"] = null,
            ["610"] = "610,3", ["611"] = "611,3", ["612"] = "612,4",
            ["613"] = "613,4", ["614"] = "614,4", ["615"] = "615,4",
            ["616"] = null, ["617"] = null, ["618"] = "618,4",
            ["619"] = null, ["620"] = "620,4",
        },
